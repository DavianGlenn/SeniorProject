  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
		...
		$sql2 = "SELECT org_name,event_name,username from socials where userid != '{$_SESSION['userid']}'" ;
	...
	{
		echo"<tr><td> {$row['username']}</td><td> {$row['event_name']}</td><td> {$row['org_name']}</td></tr>\n";
	}
	echo "</table>";
	?>
    ...
    <section class="content">
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT org_name,event_name,username from academic where userid != '{$_SESSION['userid']}'" ;
    ...
    <section class="content">
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT org_name,event_name,username from commserv where userid != '{$_SESSION['userid']}'" ;
	...
	<!-- Main content -->
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT org_name,event_name,username from careerop where userid != '{$_SESSION['userid']}'" ;
