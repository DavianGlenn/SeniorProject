...
<form  method="post" action="php/createOrg.php">
<div class="register-box">
  <div class="register-logo">
    <b>Calendly For NCAT Organizations</a>
  </div>
    ...
    <div class="card-body register-card-body">
      <p class="login-box-msg">Register a new membership</p>
        ...
        <div class="input-group mb-3">
          <input class="form-control" type="text" placeholder="Name Of Organizations" name="Org_Name">
