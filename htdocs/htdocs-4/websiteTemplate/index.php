...
// Create connection
 $con = mysqli_connect($host,$dbusername,$dbpassword,$dbname) ;
	...
	$result=mysqli_query($con, "SELECT location,title,TIME_FORMAT(Time, '%h:%i%p') as Time FROM calendarevents JOIN orgevents  ON title = orgevents.Event WHERE CURRENT_DATE=calendarevents.date and userid='{$_SESSION['userid']}' ") or die("Bad Querey");
