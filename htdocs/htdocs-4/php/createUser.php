...
$password= filter_input(INPUT_POST, 'Password');
 if(empty($firstname) || empty($lastname) || empty($username) || empty($email)|| empty($phonenumber)|| empty($password)|| empty($_POST["terms"]) ) 
{
    echo "You did not fill out the required fields. Make sure you fill out every field and please agree to the terms of agreement";
