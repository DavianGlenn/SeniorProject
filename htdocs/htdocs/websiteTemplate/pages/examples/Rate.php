    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
		...
		<a href="../../orgdash.php" class="nav-link">
            ...
            <p>Add New Event</p></a>
			<a href="whosGoingOrg.php" class="nav-link" >
            <i class="nav-icon fas fa-question"></i>
            <p>Who's Going?</p></a>
			<a href="Rate.php" class="nav-link active" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
		...
		$sql2 = "SELECT `Event`,`Rate` from `rate_events` where org_name='{$_SESSION['use']}' and type ='academic'" ;
	...
	{
		echo"<tr><td> {$row['Event']} {$row['Rate']}</td></tr>\n";
	}
	echo "</table>";
	?>
    ...
    <section class="content">
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT `Event`,`Rate` from `rate_events` where org_name='{$_SESSION['use']}' and type ='social'" ;
		
	$result= mysqli_query($conn,$sql2) or die("Badd Query:$sql2");
	echo "<table id=customers border ='1'>";
	echo "<tr><td>Event Name</td><td>Rate</td></tr>\n";
	
	while($row=mysqli_fetch_assoc($result))
	{
		echo"<tr><td> {$row['Event']} </td><td>{$row['Rate']}</td></tr>\n";
	}
	echo "</table>";
	?>
    ...
    <section class="content">
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT `Event`,`Rate` from `rate_events` where org_name='{$_SESSION['use']}' and type ='community service'" ;
	...
	<!-- Main content -->
      ...
      <div class="card">
		...
		<?php
          $conn = mysqli_connect("localhost","root","","Senior Project");
		$sql2 = "SELECT `Event`,`Rate` from `rate_events` where org_name='{$_SESSION['use']}' and type ='Career Opportunity'" ;
